declare module "@salesforce/apex/SF_QuoteController.createQuote" {
  export default function createQuote(param: {oppId: any}): Promise<any>;
}
declare module "@salesforce/apex/SF_QuoteController.getQuoteLineItemFieldNames" {
  export default function getQuoteLineItemFieldNames(): Promise<any>;
}
declare module "@salesforce/apex/SF_QuoteController.getQuoteLineItemFieldTypes" {
  export default function getQuoteLineItemFieldTypes(): Promise<any>;
}
